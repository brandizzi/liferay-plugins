...
public class JCalendarUtilTest {
	...
	@Test
	public void testToDisplayTimeLosAngelesDST() {
		Calendar jCalendar = JCalendarUtil.getJCalendar(
	...
	@Test
	public void testToDisplayTimeLosAngelesNoDST() {
		Calendar jCalendar = JCalendarUtil.getJCalendar(
	...
	@Test
	public void testToDisplayTimeSaoPauloDST() {
		Calendar jCalendar = JCalendarUtil.getJCalendar(
			2013, Calendar.JULY, 1, 12, 0, 0, 0, _utcTimeZone);
	...
	@Test
	public void testToDisplayTimeSaoPauloNoDST() {
		Calendar jCalendar = JCalendarUtil.getJCalendar(
			2013, Calendar.JANUARY, 1, 12, 0, 0, 0, _utcTimeZone);
