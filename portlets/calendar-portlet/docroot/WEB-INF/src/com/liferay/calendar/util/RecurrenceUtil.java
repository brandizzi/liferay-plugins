...
public class RecurrenceUtil {
	...
	private static CalendarBooking _copyCalendarBooking(
		...
		Calendar instanceJCalendar = JCalendarUtil.getJCalendar(
		...
		int offset = JCalendarUtil.getTimeZoneOffsetBetweenDates(
			jCalendar, instanceJCalendar, timeZone);

		long startTime = instanceJCalendar.getTimeInMillis() + offset;
		long endTime = startTime + calendarBooking.getDuration();

		newCalendarBooking.setStartTime(startTime);
		newCalendarBooking.setEndTime(endTime);
