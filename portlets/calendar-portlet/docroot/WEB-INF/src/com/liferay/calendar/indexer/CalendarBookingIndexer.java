...
public class CalendarBookingIndexer extends BaseIndexer {
	...
	protected void addLocalizedFieldText(
	...
	protected Document doGetDocument(Object obj) throws Exception {
		...
		document.addKeyword("calendarBookingId", calendarBooking.getCalendarBookingId());

		addLocalizedFieldText(
			document, "calendarName", calendarBooking.getCalendar().getNameMap(),
			defaultLocale);
	...
	protected Summary doGetSummary(
		...
		String description = getLocalizedFieldText(document, Field.DESCRIPTION, locale);
